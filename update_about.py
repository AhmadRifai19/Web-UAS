      ...
      <div class="about__inner container" style="align-items: flex-start;">
        ...
        <div class="about__text" style="flex: 1.2;">
          ...
          <div>
            ...
            <p class="about__paragraph about__paragraph--muted">
              Bertindak sebagai UX/UI Designer &amp; Web Developer, saya mengartikulasikan visi solusi ini melalui metodologi <em>Design Thinking</em>. Proses ini merangkum *Empathize* (Pemetaan Persona &amp; Affinity Diagram), *Ideation*, hingga *Prototyping* tingkat tinggi di Figma. Seluruh aset tersebut kemudian dieksekusi secara presisi menjadi struktur kode antarmuka yang dinamis, bersih, dan siap untuk skema web modern.
            </p>
          </div>
        </div>
        ...
        <div class="about__goals" style="flex: 1; position: sticky; top: 100px;">
          ...
          <div class="about__goal">
            ...
            <div>
              <h4 class="about__goal-name">One-Click Checkout &amp; Akses Darurat</h4>
              <p class="about__goal-desc">Mereduksi <em>friction</em> bertransaksi secara drastis serta menyematkan visibilitas ekstra tinggi untuk fungsi mendesak.</p>
            </div>
          </div>
          ...
          <div class="about__goal">
            ...
            <div>
              ...
              <p class="about__goal-desc">Sinkronisasi data stok secara *real-time* dengan server backend untuk memastikan keakuratan tingkat tinggi.</p>
            </div>
          </div>
        </div>
